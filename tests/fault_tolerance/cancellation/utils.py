...
def send_cancellable_request(
    ...
    if request_type == "completion":
        ...
        return send_chat_completion_request(prompt, max_tokens, frontend_port, stream=False)
    elif request_type == "chat_completion_stream":
        return send_chat_completion_request(prompt, max_tokens, frontend_port, stream=True)
    else:
